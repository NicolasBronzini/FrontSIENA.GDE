const buildTable=(data)=>
{
    ...
    let $divTabla = document.getElementById("divTablaAltaProcesoMasivoDeFirma");
    ...
    $table.setAttribute("id", "tabla_alta_firma")
...
{
    let t = document.getElementById("divTablaAltaProcesoMasivoDeFirma");
    destroyTable();  
    buildTable(data);
}
...
{
    const divTabla = document.getElementById("divTablaAltaProcesoMasivoDeFirma");
